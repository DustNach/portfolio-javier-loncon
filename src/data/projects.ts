...
export const projects: Project[] = [
...

  {
    ...
    description: 'Plataforma web para gestión de capacitaciones empresariales (experiencia laboral)',
    longDescription: 'Sistema de Gestión de Calidad desarrollado para SYC Chile. Arquitectura completa con Django REST Framework, React, TypeScript y PostgreSQL. Gestiona más de 3,000 participantes activos de 29 empresas clientes. Incluye WebSockets para comunicación en tiempo real, Celery para tareas asíncronas, CI/CD automatizado con Docker, y auditoría de seguridad OWASP con puntuación 8.5/10.',
